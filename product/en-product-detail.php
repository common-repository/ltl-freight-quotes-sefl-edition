 ...
 * Class EnSeflFreightProductDetail
 * @package EnSeflFreightProductDetail
 */
if (!class_exists('EnSeflFreightProductDetail')) {
    ...
    class EnSeflFreightProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnSeflFreightProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_sefl_freight_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_sefl_freight_plan_status($plan_status)
        {
            $en_plugin_name = 'LTL Freight Quotes - SEFL Edition';
            ...
            $plan_status['hazardous_material']['sefl_freight'][] = 'sefl_freight';
            ...
            $nesting_material = apply_filters("sefl_quotes_quotes_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting_material)) {
                $plan_required = '1';
                $nested_material_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['sefl_freight'][] = 'sefl_freight';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("sefl_quotes_plans_notification_link", [2, 3]);
    ...
    new EnSeflFreightProductDetail();
}