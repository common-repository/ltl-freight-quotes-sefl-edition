 ...
 */
if (!class_exists('EnSeflOrderRates')) {

    class EnSeflOrderRates
    {
        ...
        public function en_order_before_calculate_totals($and_taxes, $order)
        {
            ...
            if (isset($woocommerce->cart)) {
                    ...
                    foreach ($shipping as $item_id => $per_shipment) {
                        ...
                        switch ($method_id) {
                            case 'sefl':
                                ...
                                if (empty($errors)) {
                                    $shipping_class = new SEFL_Freight_Shipping_Class();
                ...
                if ($order_recreated) {
                    ...
                    $sefl_freight_curl_obj = new SEFL_Curl_Request();
                    $sefl_freight_curl_obj->sefl_get_curl_response(SEFL_FDO_HITTING_URL, $request_data);
                }
            }
        }
    }

    new EnSeflOrderRates();
}