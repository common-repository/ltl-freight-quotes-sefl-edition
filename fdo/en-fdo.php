...
class EnSeflFdo
{
    ...
    public function en_cart_package($package)
    {
        ...
        $this->en_fdo_meta_data['plugin_name'] = 'sefl_quotes';
        $accessorials['residential'] = get_option('sefl_residential') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('sefl_liftgate') == 'yes' ? true : false;
